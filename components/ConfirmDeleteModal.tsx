...
export const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({
  ...
  onCancel,
  icon,
  iconWrapperClassName = 'mx-auto w-12 h-12 bg-rose-50 border border-rose-100 rounded-full flex items-center justify-center mb-4',
  confirmClassName = 'rounded-full px-4 py-2 bg-rose-600 text-white text-sm font-medium hover:bg-rose-700 transition',
