      ...
      <div className="flex-1 min-w-0 relative flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-6">
          <div className="w-full max-w-[400px]">
            ...
            {/* La riga che dice cos'e' Sympotia, sotto il marchio. In accesso
                prende il posto del titolo e del sottotitolo: "Accedi al tuo
                ristorante" e "Inserisci le tue credenziali per continuare"
                dicevano quello che il modulo sotto gia' mostra. Il titolo resta
                per chi legge con lo schermo, che senza non saprebbe su che
                pagina e' finito. */}
