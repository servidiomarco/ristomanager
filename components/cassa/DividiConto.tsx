    ...
    <div className="flex h-full min-h-0 flex-col">
      <div className="mx-auto w-full max-w-[900px] flex-shrink-0 px-4 pb-3 pt-4 lg:px-8">
        <div className="flex items-center gap-3 rounded-[var(--ds-radius)] bg-[var(--ds-surface)] p-3 shadow-[var(--ds-shadow-card)]">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate text-[17px] font-semibold text-[var(--ds-text-primary)]">{t('splitBill')}</h1>
      ...
      <div className="mx-auto w-full min-h-0 max-w-[900px] flex-1 space-y-4 overflow-y-auto px-4 pb-6 lg:px-8">
        <div className={`grid gap-3 ${perItemAvailable ? 'sm:grid-cols-3' : 'sm:grid-cols-2'}`}>
          ...
          >
            <div className="text-[16px] font-semibold text-[var(--ds-text-primary)]">{t('byAmount')}</div>
        ...
        {(deposit > 0 || claimed > 0 || bill.paid_splits > 0) && (
          <section className="space-y-2">
            <div className="text-[13px] font-semibold text-[var(--ds-text-muted)]">{t('sharesOfBill')}</div>
            {bill.paid_splits > 0 && (
