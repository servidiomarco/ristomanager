...
**Proforma sui conti nativi (27 ago 2026):** la scelta Scontrino/Proforma della chiusura Passepartout esiste anche per i conti nativi quando un provider fiscale è attivo. La proforma nativa è un **segnaposto deliberato** (riga `PROFORMA`, provider `crm`): nessun documento fiscale alla chiusura, badge "proforma" in lista (≠ "senza scontrino" = dimenticato), e scontrino o fattura emessi dopo dal conto la **superano da soli** — il che copre anche il flusso "fattura dopo la chiusura" senza annullare scontrini.
