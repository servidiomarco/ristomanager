...
|---|---|---|
| 2026-09-03 | Comande, Cucina e Passe | La barra dei piatti raggruppati in Cucina conta tutto il servizio, non la sola coda: «3× Tagliata +2» — il numero pieno è il chiamato, il «+n» attenuato aspetta la chiamata (uscite non ancora lanciate comprese); un piatto solo-futuro è un chip attenuato. La cucina vede cosa deve ancora uscire anche fra una chiamata e l'altra. |
