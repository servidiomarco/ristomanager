...
- Nelle **uscite compresse in una riga** (uscite servite o di altre partite sulla card, uscite in arrivo, Consegnate) i piatti uguali si sommano; le righe **al peso** si sommano solo a **parità di peso**, col peso nel nome («2× Tagliata · 1 kg») — pesi diversi restano voci distinte. Anche la **barra dei piatti raggruppati** fa un chip per pezzatura: «2× Bistecca · 500 g» e «1× Bistecca · 1 kg» sono lavori diversi, e il dettaglio del chip mostra i tavoli di quella pezzatura, **con le cotture**: «al sangue» e «ben cotta» sono righe separate anche lì.
