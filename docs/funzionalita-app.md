...
- **Titoli sempre in Title Case**: nomi di piatti, categorie, varianti e ingredienti vengono normalizzati automaticamente («SPAGHETTI ALLE VONGOLE» → «Spaghetti Alle Vongole») sia al salvataggio dal CRM sia all'import dalla cassa — su tutte le superfici (menu, comande, cucina, cassa, menu pubblico, stampe). Le denominazioni restano sigle: «barolo docg» → «Barolo DOCG» (DOC, DOCG, IGT, IGP, DOP, STG, AOC, AOP).
