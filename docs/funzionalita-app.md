...
- **Uscite/portate**: ogni riga si assegna a un'uscita, e finché l'uscita è in bozza si **sposta** intera su un'altra da «sposta» in testata; la ⇅ accanto fa da maniglia: un tocco apre il selettore, **tenuta e trascinata** porta l'uscita direttamente su quella di arrivo, con l'anteprima che segue il dito e il bersaglio evidenziato; varianti libere per riga ("senza sale, metà porzione…"), quantità, coperti ±1.
