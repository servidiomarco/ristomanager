...
|---|---|---|
| 2026-09-10 | Comande, Cucina e Passe | Sotto-righe delle combinazioni nel menu (palmare, lista e a pagine): visibili da sole quando c'è struttura, la sola «liscia» si svela col doppio tap sul piatto; stepper per riga, tap che apre il suo foglio e chip dell'uscita per spostare la singola combinazione. Sul palmare si aggiunge solo dal «+» (il tap sul nome non batte). |
