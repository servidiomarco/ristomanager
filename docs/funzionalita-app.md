...
- Modifiche e annullamenti (a voce o dalle proposte WhatsApp approvate) arrivano subito su tutti gli schermi del ristorante, **nodo di sala compreso**: sulla scheda restano note, stato d'arrivo, telefono ed email. I contrassegni del cliente (VIP, tavolo preferito) e della caparra tornano al ricaricamento della pagina. Una prenotazione da confermare che Sofia modifica risulta confermata, e la campanella lo segnala.
...
|---|---|---|
| 2026-09-25 | Agente vocale "Sofia" | Le modifiche e gli annullamenti di Sofia (anche dalle proposte WhatsApp approvate) non cancellano più dalla scheda note, stato d'arrivo, telefono ed email, e arrivano anche al nodo di sala. Se Sofia modifica una prenotazione da confermare, la campanella ora segnala che è confermata (Sofia la confermava già, ma la scheda lo mostrava solo al ricaricamento). |
