...
- **Profilo** — pagina di partenza dopo il login; stile dell'interfaccia (classico con angoli morbidi, o squadrato con un raggio solo — la scelta segue l'operatore su ogni dispositivo); notifiche push del dispositivo.
