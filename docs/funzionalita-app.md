...
- A chi non è in rubrica Sofia chiede **nome e cognome in una sola domanda**; se arriva solo una parte chiede l'altra una volta («E il nome?»). Una ripetizione non diventa un secondo nome («Cesareo Cesareo») e lo spelling sostituisce la versione storpiata invece di aggiungersi.
...
- **Piano ferie** (area «Ferie» dentro Personale, accanto a Personale e Compensi):
  ...
  - **Giorni conteggiati**: solo quelli in cui il dipendente avrebbe lavorato — il riposo settimanale e i giorni di chiusura del ristorante (orari e chiusure straordinarie) non si scalano dal monte. Chi non ha un riposo fisso sulla scheda paga **6 giorni ogni 7 consecutivi** di ferie (una settimana = 6 giorni lavorativi, come nel CCNL); i periodi sotto la settimana contano per intero.
  - **Monte ferie annuo**: giorni spettanti per dipendente, oppure un valore di default del ristorante per fissi e stagionali, **in proporzione ai mesi di contratto** nell'anno (un dodicesimo per ogni mese con almeno 15 giorni, arrotondato alla mezza giornata: uno stagionale di luglio e agosto matura 2/12). Con l'**avvio del registro ferie** (nelle Regole) chi risulta assunto fino a quel giorno matura da inizio anno, perché le date inserite all'avvio dell'app non sono assunzioni vere. Le richieste a cavallo d'anno pesano sui due anni; anche le ferie registrate direttamente in calendario contano.
