...
- Nelle **uscite compresse in una riga** (uscite servite o di altre partite sulla card, uscite in arrivo, Consegnate) i piatti uguali si sommano; le righe **al peso** si sommano solo a **parità di peso**, col peso nel nome («2× Tagliata · 1 kg») — pesi diversi restano voci distinte. Anche la **barra dei piatti raggruppati** fa un chip per pezzatura **e per variante**: «2× Bistecca · 500 g», «1× Pasta al pomodoro · fusilli» e «1× Pasta al pomodoro · tagliatelle» sono chip separati (variante nella tinta delle varianti), così il cuoco sa cosa iniziare senza aprire nulla; il dettaglio del chip mostra i tavoli di quella pezzatura e variante.
