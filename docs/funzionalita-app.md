...
- **Dal tavolo alla comanda** (col modulo Sala & Cucina attivo, per chi ha il permesso di presa comanda): toccando un tavolo libero, accanto a Walk-in e Nuova prenotazione compare **Nuova comanda** — si indicano coperti ed eventuale nome, il tavolo si occupa come walk-in e si atterra in Comande sul tavolo giusto, con nome e coperti già dentro. Se sul tavolo una comanda è già aperta (o rimasta appesa da un servizio precedente) la voce lo dice con il totale e lo stato dell'uscita, e ci porta dentro invece di aprirne una seconda. Dalla scheda di una prenotazione con tavolo assegnato, e dal cassetto di dettaglio, lo stesso **Apri comanda**.
...
- **La comanda si apre anche da fuori**: dalla pianta sala di Prenotazioni (tavolo libero → «Nuova comanda», che registra il walk-in e apre la comanda in un gesto), dalla scheda della prenotazione e dal suo cassetto di dettaglio («Apri comanda»), e da Cassa («Apri in Comande»). In tutti i casi si atterra sul tavolo, sulla comanda già aperta se c'è.
...
|---|---|---|
| 2026-09-19 | Prenotazioni · Comande, Cucina e Passe | La comanda si apre dal tavolo in pianta sala: su un tavolo libero «Nuova comanda» chiede coperti e nome, registra il walk-in e porta in Comande già sul tavolo (prima bisognava cambiare pagina e ricercare lo stesso tavolo nella griglia); se una comanda è già aperta o appesa la voce lo dice col totale e ci porta dentro. Stesso «Apri comanda» nella scheda prenotazione e nel cassetto di dettaglio. Compare solo col modulo Sala & Cucina attivo e col permesso di presa comanda. |
