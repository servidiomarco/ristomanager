...
- **La griglia tavoli dice a che punto è ogni tavolo.** Le tessere si ordinano per numero di tavolo con le **sale in pista** sopra (Tutte, e una per sala col conteggio), e ognuna porta quattro righe: numero e pallino di stato, coperti, chi è al tavolo, e la riga di stato — «134,00 € · 2ª in cucina», «62,00 € · da incassare», l'ora per i prenotati, «libero». Prima il totale e lo stato dell'uscita si scoprivano aprendo il tavolo uno per uno. Le parole degli stati sono quelle delle pastiglie della comanda (in bozza, al passe, in cucina, pronta, servita): una lingua sola per la stessa informazione. Per vedere un solo stato — i conti da incassare, le comande aperte — c'è il filtro nell'imbuto.
