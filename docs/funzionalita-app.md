...
- **Protezione dell'accesso**: dopo 10 password sbagliate in 15 minuti sulla stessa email dallo stesso indirizzo, l'accesso risponde «Troppi tentativi, riprova tra qualche minuto» (contano solo i tentativi falliti, quindi lo staff che entra con la password giusta non consuma niente). Sblocco delle sezioni riservate, cambio password e cambio email hanno un tetto a parte: 10 richieste in 15 minuti per account, riuscite comprese. Se il proprietario imposta una password nuova a un utente (il modulo lo avvisa prima del salvataggio) o lo disattiva, tutti i dispositivi di quell'account dovranno rifare l'accesso. Un ristorante sospeso lo scopre solo chi ha digitato la password giusta.
...
|---|---|---|
| 2026-09-25 | Utenti, ruoli e permessi | L'accesso ha un tetto ai tentativi sbagliati: dopo 10 password errate in 15 minuti sulla stessa email risponde «Troppi tentativi, riprova tra qualche minuto» (i login riusciti non contano). Sblocco delle sezioni riservate, cambio password e cambio email: 10 richieste in 15 minuti per account. Se il proprietario imposta una password nuova a un utente (il modulo Utenti lo avvisa) o lo disattiva, tutti i dispositivi di quell'account dovranno rifare l'accesso. |
