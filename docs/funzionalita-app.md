...
- **Uscite/portate**: ogni riga si assegna a un'uscita, e finché è in bozza si **sposta** su un'altra — la singola riga o l'uscita intera. Il bottone di spostamento fa da maniglia: un tocco apre il selettore, **tenuto e trascinato** porta la riga (o l'uscita) direttamente sull'uscita di arrivo, con l'anteprima che segue il dito e il bersaglio evidenziato; varianti libere per riga ("senza sale, metà porzione…"), quantità, coperti ±1.
