...
- **Preventivo condivisibile**: ogni banchetto ha un link pubblico stabile (pagina senza login con menù per uscite, tariffe e totale, sempre aggiornata alle ultime modifiche) da inviare con un tocco **su WhatsApp** (messaggio precompilato al cliente) **o via email** (invio dal server con il pulsante «Apri il preventivo»). Le note operative interne non compaiono mai.
