...
- **Dominio e certificato del nodo li assegna la piattaforma** (il gestore vede il dominio in sola lettura). L'IP del nodo accetta solo indirizzi della rete locale; se il PC di sala cambia IP, il gestore salva quello nuovo e con **«aggiorna DNS»** ripunta il dominio (al massimo 5 volte al minuto).
...
| 2026-09-25 | Nodo di sala (modalità ibrida) | Dominio e certificato del nodo li gestisce la piattaforma: il gestore vede il dominio in sola lettura, cambia IP (solo rete locale) e porta, e con «aggiorna DNS» ripunta il dominio dopo un cambio di IP (al massimo 5 volte al minuto). |
