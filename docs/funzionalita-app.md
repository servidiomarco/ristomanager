...
- **Sullo schermo largo Comande prende la pagina intera** (la sidebar resta, ridotta a rail): la testata dell'app lascia il posto a una barra della pagina con la ricerca tavolo, l'**imbuto** e la pastiglia **Live** (ora e stato della connessione — prima si vedeva solo sui monitor di cucina). Nell'imbuto stanno il filtro per stato, il **giorno** e il **turno**, così un servizio passato — la strada per riprendere una comanda rimasta appesa — resta raggiungibile.
...
- **Il menu sullo schermo largo è a schede**: le categorie sono una fila di schede tinte (tinta del catalogo categorie, conteggio dei piatti battibili) e i piatti una griglia con **foto grande e stepper − / +** sotto il prezzo. Lo stepper si aggiunge al tocco sulla scheda, che batte come sempre; il tocco sulla foto la apre a tutto schermo per mostrarla all'ospite. I piatti senza foto tengono il riquadro col glifo, così la griglia non balla riga per riga.
- **La comanda, sullo schermo largo, sta tutta nella colonna di destra**: in testa la scheda del tavolo (Tav., coperti, Conto, ⋮ — la freccia indietro è passata nella barra della pagina), poi le uscite con la pill del nome **a sinistra** sul bordo e la spunta su quelle servite, le quantità in pastiglia, e in fondo il **riepilogo** (subtotale dei piatti, coperti come sono battuti, eventuale servizio e sconto, totale) sopra un bottone che dice cosa manda e quanto vale: «Invia 2ª uscita · 36,00 €». «Invia tutto» resta, alla sua condizione di sempre (bozze fuori dall'uscita corrente). Il riepilogo si legge soltanto: incassare, dividere e stampare restano del foglio Conto.
...
|---|---|---|
| 2026-09-12 | Comande, Cucina e Passe | Comande a schermo intero sul desktop: barra di pagina con ricerca, imbuto (stato, giorno, turno) e pastiglia Live; griglia tavoli piatta per numero con le sale in pista e la riga di stato sulla tessera (totale e uscita in corso); menu a schede categoria tinte e griglia piatti con foto e stepper; comanda nella colonna di destra col riepilogo del conto e «Invia <uscita> · <totale>». Telefono e Cassa invariati. |
