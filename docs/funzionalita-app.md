...
- **Vino consigliato**: se il piatto ha vini abbinati in scheda, il foglio varianti mostra le righe dei vini col «+» che batte il calice direttamente nell'uscita Bar — il cameriere propone e batte senza cambiare pagina. In Cassa la sezione non compare.
