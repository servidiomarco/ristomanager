...
|---|---|---|
| 2026-09-10 | Comande, Cucina e Passe | Sotto-righe delle combinazioni nel menu (palmare, lista e a pagine): visibili da sole quando c'è struttura, la sola «liscia» si svela col doppio tap sul piatto (il primo tap aggiunge, il secondo mostra); stepper per riga e tap che apre il suo foglio. |
