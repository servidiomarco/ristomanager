...
- **Dopo l'invio si torna ai tavoli**: «Invia» e «Invia tutto» chiudono la comanda e riportano alla griglia, perché il gesto successivo è quasi sempre un altro tavolo. Un piccolo volo attraversa il bottone da sinistra a destra e dice cosa è partito: il piatto per la cucina, la bottiglia per il bar, la fetta di torta per dolci e gelati — insieme quando partono insieme. Le bozze delle altre uscite restano e tornano alla riapertura.
