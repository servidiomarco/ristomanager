...
- **Elementi fissi sulla pianta**: bancone, muri divisori, colonne, piante, porte e cassa si aggiungono dalla palette (interruttore «Tavoli · Sala»), si trascinano, ruotano e misurano in cm; le modifiche si salvano in blocco con «Salva sala». Bancone, muri, colonne e cassa sono ostacoli veri: un tavolo trascinato lì sopra rimbalza.
...
- **Dentro il tavolo, la barra della pagina porta il tavolo**: accanto alla freccia di ritorno stanno **Tav. N**, i coperti in una pastiglia, chi è al tavolo col totale (**«Senza prenotazione»** per i walk-in, così il vuoto è spiegato invece che assente), e a destra Conto e ⋮. La colonna di destra resta **tutta della comanda** — un pannello solo, diviso da filetti: uscite e conto, non tre schede impilate. Le uscite in tessere (nome e pallino di stato: verde partita, ambra quella in composizione, niente pallino se l'uscita è vuota) e le uscite con la pill del nome **a sinistra** sul bordo e la spunta su quelle servite, le quantità in pastiglia, e in fondo il solo bottone d'invio — il totale sta nella barra della pagina accanto al tavolo, e il dettaglio (coperti, servizio, sconto) nel foglio Conto, dove si va per incassare. **La quantità di ogni riga porta la tinta della sua categoria**: un'uscita si legge per composizione — tre verdi e un rosa — prima di leggerne i nomi sopra un bottone che dice cosa manda e quanto vale: «Invia 2ª uscita · 36,00 €». «Invia tutto» resta, alla sua condizione di sempre (bozze fuori dall'uscita corrente). Il riepilogo si legge soltanto: incassare, dividere e stampare restano del foglio Conto.
...
|---|---|---|
| 2026-09-13 | Sale & Tavoli | Elementi fissi sulla pianta: bancone, muri, colonne, piante, porte e cassa dalla palette «Tavoli · Sala», con misure in cm, rotazione e salvataggio in blocco; bancone/muri/colonne/cassa bloccano i tavoli. |
