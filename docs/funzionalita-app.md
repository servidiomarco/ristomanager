...
|---|---|---|
| 2026-09-10 | Comande, Cucina e Passe | Sotto-righe delle combinazioni nel menu (palmare, lista e a pagine): sotto il piatto battuto con più configurazioni compaiono le sue righe («liscia», «+ Sale»…) con stepper per ciascuna e tap che apre il foglio di quella riga. |
