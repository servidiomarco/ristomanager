...
- **Titoli sempre in Title Case**: nomi di piatti, categorie, varianti e ingredienti vengono normalizzati automaticamente («SPAGHETTI ALLE VONGOLE» → «Spaghetti Alle Vongole») sia al salvataggio dal CRM sia all'import dalla cassa — su tutte le superfici (menu, comande, cucina, cassa, menu pubblico, stampe).
...
|---|---|---|
| 2026-09-12 | Menu & Banchetti | Titoli del menu normalizzati in Title Case (piatti, categorie, varianti, ingredienti), una tantum sui dati esistenti e da qui in poi a ogni salvataggio e a ogni sync dalla cassa. |
