...
class AuthApiService {
  ...
  async updatePreferences(prefs: { preferred_landing_view?: string | null; preferred_orderpad_layout?: string | null; preferred_design_style?: string | null; language?: string | null }): Promise<User> {
